...
//Test Post sem Token
axios.post('http://localhost/v1/sender', test.entrada).then(data => {
    console.log(data.data);
...
//Test get com token
axios.get('http://localhost?token=' + test.entrada_get_token).then(data => {
    console.log(data.data);
...
//Test post com token
axios.post('http://localhost/v1/sender?token=' + test.entrada_get_token, test.entrada_token).then(data => {
    console.log(data.data);
